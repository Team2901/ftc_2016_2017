...
@Autonomous(name="Red ball + Ramp", group="Autonomous")
public class redBallAndRamp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderLeftPivot(DRIVE_SPEED, second, 10.0);

        encoderDrive(DRIVE_SPEED, third, 10.0);
